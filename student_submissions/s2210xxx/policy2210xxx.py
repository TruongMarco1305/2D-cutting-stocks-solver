        ...
        for i in range(len(prod_heights)):
            ...
            if len(current_strips) < top:
                ...
                for strip in current_strips[:top]:
                    ...
                    count += 1
        # vr: top_strips, br: h_strips, min_array: so luong strip thứ i sài đc trong stock
